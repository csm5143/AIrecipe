...
export function toPinyin(ch: string): string {
  const map: Record<string, string> = {
    ...
    '静': 'jing', '境': 'jing', '镜': 'jing', '纠': 'jiu',
    '究': 'jiu', '九': 'jiu', '久': 'jiu', '酒': 'jiu', '旧': 'jiu', '救': 'jiu',
    '就': 'jiu', '举': 'ju', '句': 'ju', '巨': 'ju', '具': 'ju', '俱': 'ju', '剧': 'ju',
    '据': 'ju', '距': 'ju', '聚': 'ju', '卷': 'juan', '决': 'jue', '绝': 'jue',
    '觉': 'jue', '均': 'jun', '菌': 'jun', '军': 'jun',
    ...
    '况': 'kuang', '矿': 'kuang', '亏': 'kui', '葵': 'kui', '困': 'kun',
    ...
    '欣': 'xin', '新': 'xin', '薪': 'xin', '信': 'xin', '星': 'xing',
    '腥': 'xing', '形': 'xing', '型': 'xing', '醒': 'xing', '杏': 'xing',
    ...
    '账': 'zhang', '招': 'zhao', '昭': 'zhao',
    '找': 'zhao', '召': 'zhao', '罩': 'zhao', '兆': 'zhao', '赵': 'zhao',
    '遮': 'zhe', '折': 'zhe', '哲': 'zhe', '者': 'zhe', '这': 'zhe',
    ...
    '主': 'zhu', '注': 'zhu', '住': 'zhu', '助': 'zhu', '贮': 'zhu',
    '驻': 'zhu', '著': 'zhu', '祝': 'zhu', '筑': 'zhu', '抓': 'zhua',
